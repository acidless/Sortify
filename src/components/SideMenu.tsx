...
function SideMenu() {
    ...
    return (
        <>
            ...
            <aside
                className={`max-w-sm w-full h-full py-10 px-8 border-r dark-bg z-100 transition-all duration-300 border-neutral-700 2xl:static fixed ${isMenuOpen ? "left-0" : "-left-full"}`}>
