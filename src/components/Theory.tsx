...
function Theory() {
    ...
    return <>
        ...
        <div
            className={`absolute ${isOpen ? "right-0" : "-right-full"} transition-all h-full w-[400px] top-0 bg-neutral-900 border-l-1 border-neutral-600 duration-300 font-bold text-xl py-4 px-6 overflow-auto`}>
            {theory ||
