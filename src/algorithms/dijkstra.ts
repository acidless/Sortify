...
export type DijkstraAction =
    | { type: "visit"; node: GraphNode; distance: number }
    | { type: "relax"; from: GraphNode; to: GraphNode; oldDist: number; newDist: number }
    | { type: "update"; node: GraphNode; distance: number }
    | { type: "done" };

export function* dijkstra(start: GraphNode,nodes: GraphNode[]): Generator<DijkstraAction, void, unknown> {
